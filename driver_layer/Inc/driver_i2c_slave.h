 ...
 * @details Provides APIs to initialize, start, stop, and process interrupt-based
...
struct i2c_slave
{
    ...
    i2c_slave_event_cb_t event_cb;  /**< Event callback function */
    void                *event_ctx; /**< Event callback user context */

    /* TX byte callback ----------------------------------------------------*/

    i2c_slave_tx_byte_cb_t tx_byte_cb;  /**< TX byte callback function */
    void                  *tx_byte_ctx; /**< TX byte callback user context */
};

/* Public API --------------------------------------------------------------*/

/**
 * @brief Initialize I2C slave driver object.
 *
...
/**
 * @brief Start I2C slave peripheral.
 *
 * @param dev Pointer to I2C slave driver object.
 *
 * @return DRIVER_OK if successful, otherwise an error code.
...
/**
 * @brief Stop I2C slave peripheral.
 *
 * @param dev Pointer to I2C slave driver object.
 *
 * @return DRIVER_OK if successful, otherwise an error code.
...
/**
 * @brief Set I2C slave event callback.
 *
 * @param dev Pointer to I2C slave driver object.
...
/**
 * @brief Set I2C slave TX byte callback.
 *
 * @param dev Pointer to I2C slave driver object.
...
/**
 * @brief Process I2C slave event interrupt.
 *
 * @note Must be called from I2C event IRQ handler.
 *
 * @param dev Pointer to I2C slave driver object.
 */
void i2c_slave_ev_irq_process(i2c_slave_t *dev);

/**
 * @brief Process I2C slave error interrupt.
 *
 * @note Must be called from I2C error IRQ handler.
 *
 * @param dev Pointer to I2C slave driver object.
 */
void i2c_slave_er_irq_process(i2c_slave_t *dev);
